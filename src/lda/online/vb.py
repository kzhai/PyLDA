...
"""
class VariationalBayes(VariationalBayes):
    """
    """
#    def __init__(self,
#
...
#        
#        super(VanillaLDA, self).__init__(alpha_update_decay_factor, 
#                                        alpha_maximum_decay, 
...
#        self._beta_title = "beta-";
    ...
    def _initialize(self, data, num_topics=10, batch_size=1, kappa=0, tau=1024):
        ...
        super(VariationalBayes, self)._initialize(data, num_topics);
        ...
        self._beta = scipy.special.psi(self._lambda) - scipy.special.psi(numpy.sum(self._lambda, axis=0)[numpy.newaxis, :]);
    ...
    def update_phi(self, doc_id, phi_table):
        ...
        for gamma_iteration in xrange(self._gamma_maximum_iteration):
            ...
            phi_contribution = self._beta[term_ids, :] + numpy.log(self._gamma[[doc_id], :]);
    ...
    def learning(self, iteration=0):
        ...
        for i in xrange(iteration):
            ...
            self._beta = (scipy.special.psi(self._lambda) - scipy.special.psi(numpy.sum(self._lambda, 0))[numpy.newaxis, :]);
